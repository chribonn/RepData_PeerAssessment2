...
From the chart it is clearly visble that the event that costs the most in terms of harmful events to humans are those classified under **`r data2[maxr, "EventType"]`**.
...
max2r <- order(maxs$Amount, decreasing = TRUE)[1]
```


From the chart it is clearly visble that the event that costs the most in terms of harmful events to humans are those classified under **`r data3[max2r, "EventType"]`**.
